  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        {/* mx-auto - margin horizontal auto - this will align all the contants horizontally */}
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
          <h1 className="h1 mb-6">
            {/* {` `} - is used to add a whitespace */}
            Travel Smarter, Not Harder with {` `}
          ...
          <Button className={`hover:text-color-7`} href="/pricing">
            Start Here!
          </Button>
        </div>
          ...
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8 rounded-[1rem]">
              ...
              >
                <img
                  src={robot}
                  className="w-full sclae-[1.7] -translate-y-24 md:scale-[1] md:-translate-y-[10%] lg:-translate-y-[35%]"
                  width={1024}
                  height={490}
                  alt="AI"
                />
                ...
                {/* the left scrolling thing from the robot image */}
